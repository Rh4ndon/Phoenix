                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form id="add_student" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="pr" class="input focused" id="focusedInput" type="text" placeholder = "Parent/Guadian Fullname" required>
                                          </div>
                                        </div>

										<div class="control-group">
                                          <div class="controls">
                                            <input  name="pn" class="input focused" id="focusedInput" type="text" placeholder = "Parent Cp# format +639123456780" required>
                                          </div>
                                        </div>
