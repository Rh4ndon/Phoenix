    ...
    <div class="container">
        <div class="login-container">
            ...
            <form action="controllers/login.php" method="POST">
                ...
                <button type="submit" name="login" class="btn btn-primary btn-login mb-3">Launch</button>
            </form>
            <div class="additional-links">
                <p>New explorer?</p>
            </div>
            <a href="register.php"><button type="button" class="btn btn-outline-primary btn-login mb-3">Begin Adventure</button></a>
        </div>
    </div>
