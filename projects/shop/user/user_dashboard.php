                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $row_user['firstname'] ?> <?php echo $row_user['lastname'] ?></span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                     ...
                     <div class="card shadow mb-4 mr-4">
                                ...
                                <div class="col-sm-4">
                                <button type="submit" name="addonlinecart" class="btn btn-primary btn-user btn-block" disabled>Add to cart</button>
                                </div>
                    ...
                    <div class="card shadow mb-4 ml-4">
                        ...
                        <div class="card-body">
		                    ...
		                    ?>
                                ...
                                <div class="col-sm-4">
                                <button type="submit" name="order" class="btn btn-primary btn-user btn-block" disabled>Oder Items</button>
                                </div>
                     ...
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">List of Products Available</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
