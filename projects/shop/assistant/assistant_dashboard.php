            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                                ...
                                <div class="col-sm-4">
                                <button type="submit" name="add" class="btn btn-primary btn-user btn-block" disabled>Add</button>
                                </div>
                                </form>
                                </div>
                    </div>
                        ...
                        <div class="card-body">
		                    ...
		                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <button name="edit" type="submit" class="btn btn-primary btn-icon-split" disabled>
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-flag"></i>
                                                </span>
                                                <span class="text">Edit</span>
                                            </button>
                                            <button name="delete" type="submit" class="btn btn-danger btn-circle" disabled>
