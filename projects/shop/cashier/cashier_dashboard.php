                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                     ...
                     <div class="card shadow mb-4 mr-4">
                                ...
                                <div class="col-sm-4">
                                <button type="submit" name="addcart" class="btn btn-primary btn-user btn-block" disabled>Add to cart</button>
                                </div>
                    ...
                    <div class="card shadow mb-4 ml-4">
                        ...
                        <div class="card-body">
		                    ...
		                    ?>
                                ...
                                <div class="col-sm-4">
                                <button type="submit" name="sell" class="btn btn-primary btn-user btn-block" disabled>Sell</button>
                                </div>
                                <br>
                        ...
                        <div class="card-body">
		                    ...
		                    ?>
                                        <tr>
                                            ...
                                            <button name="confirm" type="submit" class="btn btn-primary btn-icon-split" disabled>
                                  ...
                                  <?php } elseif($stat == 'Returned'){ ?>
                                            ...
                                            <input type="hidden" name="order_id" value="<?php echo $row2['order_id']; ?>">
                                            <input type="hidden" name="customer" value="<?php echo $row2['fname']; ?> <?php echo $row2['lname']; ?>">
                                            <button name="putback" type="submit" class="btn btn-primary btn-icon-split" disabled>
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-check"></i>
                                                </span>
                                                <span class="text">Put Back</span>
                                            </button>
                                            <button name="damaged" type="submit" class="btn btn-danger btn-icon-split" disabled>
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-check"></i>
                                                </span>
